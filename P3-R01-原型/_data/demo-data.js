...
window.DM = (function () {
 ...
 "todoView": {
  ...
  "stalls": [
   ...
   {
    "tr": "<div class=\"stall-item\" onclick=\"go('../项目库/P3-R01-F02-项目详情-项目概况.html')\">\n<span class=\"warn-days\">⚠ 停滞 47 天</span>\n<span class=\"t-name\">磐石量子 · ④ 尽调/访谈</span>\n<span class=\"t-sub\">超 30 天未推进</span>\n</div>"
   }
  ],
  "mines": [
   {
 ...
 "__f19Groups": [
  ...
  store.dictionaries = [
    ...
    {"key": "apType", "name": "审批类型", "note": "审批发起使用的审批类型维度", "grouped": false, "items": [{"name": "立项", "status": "启用", "sort": 1}, {"name": "投决", "status": "启用", "sort": 2}, {"name": "基金注册", "status": "启用", "sort": 3}, {"name": "付款", "status": "启用", "sort": 4}, {"name": "分配", "status": "启用", "sort": 5}, {"name": "注销", "status": "启用", "sort": 6}], "rowTr": "<tr><td>立项</td><td><span class=\"tag tag-blue\">启用</span></td><td>1</td><td class=\"sticky-op ops\"><a onclick=\"dmEditDict('立项')\">编辑</a><a class=\"danger-op\" onclick=\"alert('已停用：立项')\">停用</a></td></tr>\n<tr><td>投决</td><td><span class=\"tag tag-blue\">启用</span></td><td>2</td><td class=\"sticky-op ops\"><a onclick=\"dmEditDict('投决')\">编辑</a><a class=\"danger-op\" onclick=\"alert('已停用：投决')\">停用</a></td></tr>\n<tr><td>基金注册</td><td><span class=\"tag tag-blue\">启用</span></td><td>3</td><td class=\"sticky-op ops\"><a onclick=\"dmEditDict('基金注册')\">编辑</a><a class=\"danger-op\" onclick=\"alert('已停用：基金注册')\">停用</a></td></tr>\n<tr><td>付款</td><td><span class=\"tag tag-blue\">启用</span></td><td>4</td><td class=\"sticky-op ops\"><a onclick=\"dmEditDict('付款')\">编辑</a><a class=\"danger-op\" onclick=\"alert('已停用：付款')\">停用</a></td></tr>\n<tr><td>分配</td><td><span class=\"tag tag-blue\">启用</span></td><td>5</td><td class=\"sticky-op ops\"><a onclick=\"dmEditDict('分配')\">编辑</a><a class=\"danger-op\" onclick=\"alert('已停用：分配')\">停用</a></td></tr>\n<tr><td>注销</td><td><span class=\"tag tag-blue\">启用</span></td><td>6</td><td class=\"sticky-op ops\"><a onclick=\"dmEditDict('注销')\">编辑</a><a class=\"danger-op\" onclick=\"alert('已停用：注销')\">停用</a></td></tr>\n"},
