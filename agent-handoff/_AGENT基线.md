...
| 原型说明（版本行=防并行覆盖标记） | `/Users/bailey/Desktop/xiaohei-workplace/FundFlow/P3-R01-原型说明.md`（当前 **V1.7**） |
| 术语表（唯一术语源） | `/Users/bailey/Desktop/xiaohei-workplace/FundFlow/P1-R02-术语表.md` |
| 需求调整记录（A 系列，下一个号 **A15**） | `/Users/bailey/Desktop/xiaohei-workplace/FundFlow/P2-R01/` |
