...
- **菜单**：一级 9 项 = 工作台 + 项目库/基金管理/审批中心 3 直达（A15 拍平审批中心单子项组）+ LP 管理/投后管理/退出管理/统计报表/系统管理 5 组（A16 组名由退出与分配更名）；投后管理 4 项（投后项目 F22/报告归档/风险预警/提醒中心）、退出管理 3 项（退出项目 F23/收益分配/清算注销）、详情页不进菜单（列表行进入，A05/A12 口径）
